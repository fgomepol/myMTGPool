...
const appRoutes: Routes = [
  ...
  { path: 'listadoBarajas/:id', component: ListadoBarajasComponent, canActivate: [ AuthorizatedGuardComponent ] },
  { path: 'cartasBaraja/:id/:id2', component: CartasBarajaComponent, canActivate: [ AuthorizatedGuardComponent ] },
