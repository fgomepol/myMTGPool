...
const appRoutes: Routes = [
  ...
  { path: 'torneos/:id/:id2', component: TorneosComponent, canActivate: [ AuthorizatedGuardComponent ] },
  ...
  { path: 'listadoBarajas/:id/:id2/:id3', component: ListadoBarajasComponent, canActivate: [ AuthorizatedGuardComponent ] },
  { path: 'cartasBaraja/:id/:id2/:id3/:id4', component: CartasBarajaComponent, canActivate: [ AuthorizatedGuardComponent ] },
  { path: 'arquetipo/:id/:id2', component: ArquetipoComponent, canActivate: [ AuthorizatedGuardComponent ] },
  { path: 'arquetipo/:id/:id2/:id3', component: ArquetipoComponent, canActivate: [ AuthorizatedGuardComponent ] },
